                    ...
                    splashAd.setFullScreenContentCallback(
                            new FullScreenContentCallback() {
                                ...
                                public void onAdClicked() {
                                    super.onAdClicked();
                                    if (currentActivity != null) {
                                        TdLogEventManager.logClickAdsEvent(currentActivity, splashAdId);
            ...
            if (appResumeAd != null) {
                appResumeAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                    ...
                    public void onAdClicked() {
                        super.onAdClicked();
                        if (currentActivity != null) {
                            TdLogEventManager.logClickAdsEvent(currentActivity, appResumeAdId);
                            if (fullScreenContentCallback != null) {
                                fullScreenContentCallback.onAdClicked();
                            }
                        }
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        interstitialAd.setOnPaidEventListener(adValue -> {
                            TdLogEventManager.logPaidAdImpression(activity,
                                    adValue,
                                    interstitialAd.getAdUnitId(),
                                    interstitialAd.getResponseInfo()
                                            .getMediationAdapterClassName(), AdType.INTERSTITIAL);
                            TdLogEventManager.logPaidAdjustWithToken(adValue, interstitialAd.getAdUnitId(), TdAdConfig.ADJUST_TOKEN_TIKTOK);
        ...
        new Handler().postDelayed(() -> {
            splashAd.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            TdLogEventManager.logClickAdsEvent(context, splashAdId);
        ...
        new Handler().postDelayed(() -> {
            mOpenSplashHigh1.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            TdLogEventManager.logClickAdsEvent(activity, mOpenSplashHigh1.getAdUnitId());
                            adCallback.onAdClicked();
        ...
        new Handler().postDelayed(() -> {
            mOpenSplashHigh2.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            TdLogEventManager.logClickAdsEvent(activity, mOpenSplashHigh2.getAdUnitId());
                            adCallback.onAdClicked();
        ...
        new Handler().postDelayed(() -> {
            mOpenSplashHigh3.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            TdLogEventManager.logClickAdsEvent(activity, mOpenSplashHigh3.getAdUnitId());
                            adCallback.onAdClicked();
        ...
        new Handler().postDelayed(() -> {
            mOpenSplashNormal.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            TdLogEventManager.logClickAdsEvent(activity, mOpenSplashNormal.getAdUnitId());
                            adCallback.onAdClicked();
