...
import com.ads.td.ads.wrapper.StatusAd;
...
public class TdAdPlacer {
    String TAG = "TdAdPlacer";
    private HashMap<Integer, ApNativeAd> listAd = new HashMap<>();
    private List<Integer> listPositionAd = new ArrayList<>();
    private TdAdPlacerSettings settings;
    private RecyclerView.Adapter adapterOriginal;
    private Activity activity;
    private int countLoadAd = 0;

    public TdAdPlacer(TdAdPlacerSettings settings, RecyclerView.Adapter adapterOriginal, Activity activity) {
                ...
                holder.itemView.post(() -> {
                    ...
                    Admob.getInstance().loadNativeAd(activity, settings.getAdUnitId(), new AdCallback() {
                        ...
                        public void onUnifiedNativeAdLoaded(@NonNull NativeAd unifiedNativeAd) {
                            ...
                            unifiedNativeAd.setOnPaidEventListener(new OnPaidEventListener() {
                                ...
                                public void onPaidEvent(@NonNull AdValue adValue) {
                                    TdAdPlacer.this.onAdRevenuePaid(new ApAdValue(adValue));
                                }
                            });

                            TdAdPlacer.this.onAdLoaded(pos);
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            TdAdPlacer.this.onAdClicked();
                        }

                        @Override
                        public void onAdImpression() {
                            super.onAdImpression();
                            TdAdPlacer.this.onAdImpression();
                        }
    ...
    public void loadAds() {
        ...
        }, Math.min(listAd.size(), settings.getPositionFixAd()), TdAdConfig.ADJUST_TOKEN_TIKTOK);
    }
