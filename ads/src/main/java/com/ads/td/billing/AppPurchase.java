...
import com.ads.td.funtion.BillingListener;
import com.ads.td.funtion.PurchaseListener;
import com.ads.td.funtion.UpdatePurchaseListener;
...
/*    private String logResultBilling(Purchase.PurchasesResult result) {
    ...
    private void handlePurchase(Purchase purchase) {
        ...
        TdLogEventManager.onTrackRevenuePurchase((float) price, currency, idPurchaseCurrent, typeIap);
