...
~~~
    ...
    implementation 'com.github.trongluan99:TD-Studio:$version'
...
~~~   
TdAd.getInstance().loadCollapsibleBanner(this, BuildConfig.ad_banner, AppConstant.CollapsibleGravity.BOTTOM, new AdCallback());
~~~   
